...
#  ResUNet14
net_arg.add_argument('--model', type=str, default='Res16UNet34D', help='Model name')
...
# Loss params
opt_arg.add_argument('--loss_type', type=str, default='cross_entropy')  # cross_entropy, focal, weighted_ce, uf
...
data_arg.add_argument('--ply_path', type=str, default='')
data_arg.add_argument('--txt_path', type=str, default='')
