...
#               'scene0685_02']
import os
file_name = os.listdir('/home/ynjuan/final-project-challenge-2-teamname/dataset/train')
train_name = []
for name in file_name:
    train_name.append(name.replace('.ply', ''))
TRAIN_SCENES = train_name

file_name = os.listdir('/home/ynjuan/final-project-challenge-2-teamname/dataset/test')
test_name = []
for name in file_name:
    test_name.append(name.replace('.ply', ''))
VAL_SCENES = test_name
