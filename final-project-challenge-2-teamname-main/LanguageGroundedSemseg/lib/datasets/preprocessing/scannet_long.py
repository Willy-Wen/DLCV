...
SCANNET_RAW_PATH = Path('/home/ynjuan/final-project-challenge-2-teamname/download_train')
SCANNET_OUT_PATH = Path('/home/ynjuan/final-project-challenge-2-teamname/process')
...
print('>>>>>train scene:', train_scenes)
print(train_pc_files)
