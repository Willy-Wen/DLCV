...
class ScannetVoxelizationDataset(VoxelizationDataset):
    ...
    def add_instances_to_cloud(self, coords, feats, labels, scene_name, transformations):
        ...
        for sample in samples:
            ...
            try:
                ...
                print('>>>>>Error occur at augmentation!')
    ...
    def test_pointcloud(self, pred_dir, visualize_path, num_labels):

        print('Running full pointcloud evaluation.')
        eval_path = os.path.join(pred_dir)
        ...
        for i, data_path in enumerate(self.data_paths):
            ...
            pred = np.load(glob.glob(visualize_path + '/*pred*%04d.npy' % i)[0])
            ...
            # print('>>>>>data path, label:', data_path, query_label)
